    ...
    <div class="vr-body">
      <div class="vr-chart-box">
        <div class="vr-chart-box__pie">
          <apexchart height="150" type="donut" :options="chartOptions" :series="series"></apexchart>
        </div>
        <section>
          <div class="vr-chart-box__name">Coinvote</div>
          <div class="vr-chart-box__result">83%</div>
      ...
      <div class="vr-chart-box">
        ...
        <section>
          ...
          <div class="vr-chart-box__result vr-chart-box__result--red">56%</div>
          <div class="vr-chart-box__info">
            <div>323 GWEI</div>
      ...
      <div class="vr-chart-box">
        ...
        <section>
          ...
          <div class="vr-chart-box__result">53%</div>
          <div class="vr-chart-box__info">
            <div>23 000 ETH</div>
            <div>3% of all ETH</div>
          </div>
    ...
    <div class="vr-footer">
      ...
      <div class="vr-footer__right">
        <div class="vr-buttons">
          <button class="vr-btn vr-btn--success">Yea</button>
          <button class="vr-btn vr-btn--danger">Nay</button>
          <button class="vr-btn vr-btn--default">Abstain</button>
        </div>
      </div>
    </div>
  </div>
