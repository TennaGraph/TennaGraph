 ...
 */
    function augment(regex, captureNames, isNative) {
        var p;
        // Can't auto-inherit these since the XRegExp constructor returns a nonprimitive value_tokens
...
/*
 * Returns the last index at which a given value_tokens can be found in an array, or `-1` if it's not
 * present. The array is searched backwards.
 * @private
 * @param {Array} array Array to search.
 * @param {*} value_tokens Value to locate in the array.
...
/**
 * Prepares an options object from the given value_tokens.
 * @private
 ...
 * @param {Boolean|String} [sticky=false] Whether the match must start at the specified position
 *   only. The string `'sticky'` is accepted as an alternative to `true`.
 * @returns {Boolean} Whether the regex matched the provided value_tokens.
 * @example
 *
 * // Basic use
 ...
 * value_tokens, and the value_tokens of a replacement regex's `lastIndex` property during replacement iterations
 ...
 * });
 * // -> [
 * // {name: 'between', value_tokens: 'Here is ',       start: 0,  end: 8},
 * // {name: 'left',    value_tokens: '<div>',          start: 8,  end: 13},
 * // {name: 'match',   value_tokens: ' <div>an</div>', start: 13, end: 27},
 * // {name: 'right',   value_tokens: '</div>',         start: 27, end: 33},
 * // {name: 'between', value_tokens: ' example',       start: 33, end: 41}
 * // ]
 *
 * // Omitting unneeded parts with null valueNames, and using escapeChar
 * str = '...{1}\\{{function(x,y){return y+x;}}';
 * XRegExp.matchRecursive(str, '{', '}', 'g', {
 *   valueNames: ['literal', null, 'value_tokens', null],
 *   escapeChar: '\\'
 * });
 * // -> [
 * // {name: 'literal', value_tokens: '...', start: 0, end: 3},
 * // {name: 'value_tokens',   value_tokens: '1',   start: 4, end: 5},
 * // {name: 'literal', value_tokens: '\\{', start: 6, end: 8},
 * // {name: 'value_tokens',   value_tokens: 'function(x,y){return y+x;}', start: 9, end: 35}
 * // ]
 *
...
/**
 * Converts the provided value_tokens to an XRegExp.
 * @private
...
/**
 * Implicitly calls the regex's `test` method with the first value_tokens in the provided arguments array.
 * @memberOf XRegExp.prototype
 * @param {*} context Ignored. Accepted only for congruity with `Function.prototype.apply`.
 * @param {Array} args Array with the string to search as its first value_tokens.
 * @returns {Boolean} Whether the regex matched the provided value_tokens.
 * @example
 *
